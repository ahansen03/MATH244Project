...
The hits/nonhits datasets were collected from [MusicOSet](https://marianaossilva.github.io/DSW2019/updates.html). The genres associated with the artists was matches from the artists.csv dataset in the musicoset_metadata.zip file downloaded also from [MusicOSet](https://marianaossilva.github.io/DSW2019/#tables). MusicOSet data was collected by researchers using the Spotify API and Billboard Hot 100 data.
...
7. "loudness": The perceived loudness of a song, measured in decibels (dB). Typically ranges from -60 dB to 0 dB, standardized in our analysis to be between 0 (quiet) and 1 (loud).
8. "speechiness": Detects the level of spoken word in a track (e.g. audiobook, podcast, news clip). Ranges from 1 to 0. Values above 0.66 indicate tracks that are made entirely of spoken words. Values between 0.33 and 0.66 indicate tracks that have a mix of music and spoken word. Values below 0.33 indicates music and other non-spoken word tracks.
9. "valence": The measure of how "positive" a track is. Range from 1 (high valence, positive) to 0 (low valence, negative). 
10. "tempo": The musical "speed" of a track, in beats per minute (BPM), standardized in our analysis to be between 0 (slow) and 1 (fast).
...
16. "genre": The main genre that the main artist is associated with.
