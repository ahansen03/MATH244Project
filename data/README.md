...
1. "duration_ms": The length of the track (in milliseconds), standardized in our analysis to be between 0 and 1.
...
7. "loudness": The perceived loudness of a song, measured in decibels (dB). Typically ranges from -60 dB to 0 dB, standardized in our analysis to be between 0 and 1.
...
10. "tempo": The musical "speed" of a track, in beats per minute (BPM), standardized in our analysis to be between 0 and 1.
